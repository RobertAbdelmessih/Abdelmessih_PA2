...

{
              ...
              ratings[i][j] = 0;
                               ...
                               System.out.print("Please enter the number of people rating: ");
...

{
                              ...
                              System.out.println("Please rate each topic in the scale 1 to 10 for the below "+topics.length+" topics : ");
               for(j=0;j<topics.length;j++)
{
                               System.out.print("Please enter your rating for "+topics[j]+" : ");
...

{
     ...
     for(j=0;j<ratings[i].length;j++)
             ...
             System.out.println("\nThe highest Point total : "+highestPointTotal+" Issue : "+highestPointIssue);
             System.out.println("\nThe lowest Point total : "+lowestPointTotal+" Issue : "+lowestPointIssue);            
             scnr.close();  
}
}